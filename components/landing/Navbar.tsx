    ...
    <div className="fixed top-0 left-0 right-0 z-50 px-4 md:px-6 pt-2 md:pt-4">
      ...
      <div className="bg-bg/60 backdrop-blur-md border border-accent/20 py-1.5 px-4 rounded-full flex items-center justify-between text-[9px] font-bold uppercase tracking-[0.2em] text-accent/80 mb-2 max-w-7xl mx-auto shadow-xl">
         <div className="flex items-center gap-2">
            <div className="w-4 h-4 rounded-full bg-surface-3 border border-accent/30 overflow-hidden bg-[url('/mateusz.jpg')] bg-cover bg-center" />
            <span className="hidden sm:inline">Built by emdes515</span>
            <span className="sm:hidden">by emdes515</span>
         </div>
         <div className="flex items-center gap-4">
           ...
           <Link 
             href="https://github.com/emdes515" 
             target="_blank"
             className="flex items-center gap-2 hover:text-accent transition-colors"
           >
              <Code size={12} />
      ...
      >
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="https://github.com/emdes515/finary-personal-finance-app" target="_blank" className="text-sm text-text-muted hover:text-text transition-colors flex items-center gap-2">
